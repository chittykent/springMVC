package com.app.tracker.model.util;
...
import com.app.tracker.model.common.BaseEntity;
import com.app.tracker.model.common.LabelValue;
...
public final class ConvertUtil {
    ...
    public static Object getOpposingObject(Object o) throws ClassNotFoundException,
        ...
        if (o instanceof BaseEntity) {
            ...
            name = StringUtils.replace(name, ".model.", ".webapp.model.");
            ...
            name = StringUtils.replace(name, ".webapp.model.", ".model.");
